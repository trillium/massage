...
export const gratuityLinks: QuickLink[] = [
  {
    label: 'Venmo',
    href: 'https://venmo.com/KendraAnderson',
    icon: SiVenmo,
    description: '@KendraAnderson',
    accent: 'border-blue-400 dark:border-blue-600',
    iconColor: 'text-blue-600 dark:text-blue-400',
  },
  {
    label: 'CashApp',
    href: 'https://cash.app/$flowerflyther',
    icon: SiCashapp,
    description: '$flowerflyther',
...
export const quickLinks: QuickLink[] = [
  {
    ...
    href: '/book',
    icon: FaCalendarAlt,
    description: 'Schedule your reading session',
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/flowerflyther',
    icon: FaInstagram,
    description: '@flowerflyther',
  ...
  {
    label: 'Email',
    href: 'mailto:kendra@flowerflyther.com',
    icon: FaEnvelope,
    description: 'kendra@flowerflyther.com',
