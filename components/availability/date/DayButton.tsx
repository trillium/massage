      ...
      <label
        ...
        className={clsx('relative flex flex-col items-center transition-all', props.className, {
          'hocus:shadow-sm hocus:shadow-primary-100 hocus:z-10 cursor-pointer font-semibold':
            !isDisabled,
          'bg-surface-300 text-accent-800 dark:bg-surface-800 dark:text-accent-200':
            !isDisabled && !isSelected,
          'bg-surface-50 text-accent-500 dark:bg-surface-200 dark:text-accent-500': isDisabled,
          'bg-primary-500 dark:bg-primary-600 text-white dark:text-accent-100': isSelected,
        })}
