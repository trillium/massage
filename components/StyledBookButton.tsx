interface StyledBookButtonProps {
  href: string
  text: string
...
export default function StyledBookButton({
  ...
  const colors = {
    ...
    primary: {
      ...
      text: 'text-accent-950 dark:text-white',
  ...
  const linkClasses = `group relative mb-4 inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full border-4 pr-14 pl-6 font-medium ${style.border} ${style.decoration} hover:text-white`
