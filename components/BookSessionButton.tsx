...
const BookSessionButton: React.FC<BookSessionButtonProps> = ({ href, title }) => (
  ...
  >
    <Box className="bg-primary-500 group-hover:from-primary-400 group-hover:via-primary-500 group-hover:to-primary-500 absolute right-0 -z-0 inline-flex h-12 w-12 items-center justify-end rounded-full transition-[width] group-hover:w-[calc(100%)] group-hover:bg-gradient-to-r group-hover:text-white">
      <Stack className="mr-3.5" direction="row" align="center" justify="center">
        <svg
          ...
          className="stroke h-5 w-5 stroke-black group-hover:stroke-white dark:stroke-white"
        >
          <path
