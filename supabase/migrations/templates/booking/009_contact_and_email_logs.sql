...
CREATE INDEX IF NOT EXISTS idx_contact_submissions_send_state ON contact_submissions(send_state);
...
CREATE INDEX IF NOT EXISTS idx_email_sends_to_address  ON email_sends(to_address);
CREATE INDEX IF NOT EXISTS idx_email_sends_created_at  ON email_sends(created_at);
CREATE INDEX IF NOT EXISTS idx_email_sends_send_state  ON email_sends(send_state);
