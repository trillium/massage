...
CREATE UNIQUE INDEX IF NOT EXISTS idx_google_credentials_email
  ON trillium_massage.google_credentials(email);
...
CREATE POLICY "Service role full access on google_credentials"
  ON trillium_massage.google_credentials FOR ALL
...
CREATE INDEX IF NOT EXISTS idx_appointments_start_time
  ON trillium_massage.appointments(start_time);
CREATE INDEX IF NOT EXISTS idx_appointments_status
  ON trillium_massage.appointments(status);
CREATE INDEX IF NOT EXISTS idx_appointments_calendar_event_id
  ON trillium_massage.appointments(calendar_event_id);
CREATE INDEX IF NOT EXISTS idx_appointments_client_email
  ON trillium_massage.appointments(client_email);
...
CREATE POLICY "Service role full access on appointments"
  ON trillium_massage.appointments FOR ALL
  USING (auth.role() = 'service_role');
...
CREATE INDEX IF NOT EXISTS idx_reminder_logs_reminder
  ON trillium_massage.reminder_logs(reminder_id);
...
CREATE POLICY "Service role full access on reminder_logs"
  ON trillium_massage.reminder_logs FOR ALL
  USING (auth.role() = 'service_role');
...
CREATE INDEX IF NOT EXISTS idx_audit_booking
  ON trillium_massage.invoice_audit_log(booking_id);
CREATE INDEX IF NOT EXISTS idx_audit_square_invoice
  ON trillium_massage.invoice_audit_log(square_invoice_id);
CREATE INDEX IF NOT EXISTS idx_audit_event_type
  ON trillium_massage.invoice_audit_log(event_type);
CREATE INDEX IF NOT EXISTS idx_audit_created_at
  ON trillium_massage.invoice_audit_log(created_at);
CREATE UNIQUE INDEX IF NOT EXISTS idx_audit_idempotency
  ON trillium_massage.invoice_audit_log(idempotency_key)
...
CREATE POLICY "Service role full access on invoice_audit_log"
  ON trillium_massage.invoice_audit_log FOR ALL
  USING (auth.role() = 'service_role');
