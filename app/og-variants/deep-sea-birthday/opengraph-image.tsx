    ...
    >
      ...
      <div
        style={{
          ...
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(180deg, #010d1a 0%, #010d1a 60%, #00080f 100%)',
        }}
      />
      ...
      <div
        style={{
          ...
          height: 480,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(0,229,200,0.07) 0%, rgba(0,229,200,0) 70%)',
        }}
      />
      ...
      <div
        style={{
          ...
          height: 400,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(0,100,200,0.08) 0%, rgba(0,100,200,0) 70%)',
        }}
      />
      ...
      <div
        style={{
          ...
          height: 2,
          background:
            'linear-gradient(90deg, rgba(0,229,200,0) 0%, rgba(0,229,200,0.5) 40%, rgba(0,229,200,0.15) 100%)',
        }}
      />
    </div>,
    { ...size }
