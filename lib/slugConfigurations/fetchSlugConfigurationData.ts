...
const slugConfigurations: SlugConfigurationType[] = [
  ...
  },
  {
    ...
    pricingLabels: {
      ...
      120: '+15 min free! (135 min session)',
    },
  ...
  },
  {
    ...
    hideLocation: true,
    title: 'Recharge while you charge!',
    text: "Quick session while your Tesla charges. Book a time and I'll come to you.",
    defaultDuration: 15,
    allowedDurations: [5, 10, 15, 20, 30, 45],
    pricing: { 5: 12, 10: 23, 15: 35, 20: 47, 30: 70, 45: 105 },
